...
const AppointmentSchema = new mongoose.Schema(
	{
		...
		resultados_estudios: {
			type: [
				{
					nombre: {
						...
						maxlength: [
							100,
							'El nombre del estudio no puede tener más de 100 caracteres',
						],
					},
					pdf: {
						type: String,
						...
						validate: {
							...
							message: 'El archivo debe ser una URL vÃ¡lida que termine en .pdf',
						},
					},
					fecha_carga: {
						type: Date,
						...
						validate: {
							validator: function (v) {
								return v <= new Date(); // No se permite fecha futura
							},
			...
			validate: {
				validator: function (v) {
					return v.length <= 10; // Limita a máximo 10 estudios
				},
